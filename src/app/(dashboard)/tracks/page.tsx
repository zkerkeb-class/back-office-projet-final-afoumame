...
export default function TracksPage() {
  ...
  const [searchArtistId, setSearchArtistId] = useState<string>('all');
  const [searchAlbumId, setSearchAlbumId] = useState<string>('all');
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    setSearchParams({
      ...
      artistId: searchArtistId === 'all' ? undefined : searchArtistId,
      albumId: searchAlbumId === 'all' ? undefined : searchAlbumId,
  ...
  const resetSearch = () => {
    setSearchTitle('');
    setSearchArtistId('all');
    setSearchAlbumId('all');
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <form onSubmit={handleSearch} className="flex items-center gap-2">
            ...
            <Select
              value={searchIsSingle === undefined ? 'all' : searchIsSingle.toString()}
              onValueChange={value =>
                setSearchIsSingle(value === 'all' ? undefined : value === 'true')
              }
            >
              <SelectTrigger className="w-[200px]">
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={value =>
                          setTrackForm(prev => ({ ...prev, artistId: value }))
                        }
                        required
                      >
                        <SelectTrigger>
                    ...
                    {!trackForm.isSingle && (
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setTrackForm(prev => ({ ...prev, albumId: value }))
                          }
                          required
                        >
                          <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={e =>
                          setTrackForm(prev => ({ ...prev, duration: e.target.value }))
                        }
                        required
                      />
                    </div>
